  ...
  return (
    <header className="border-b border-[var(--fw-border)] bg-[var(--fw-bg)]">
      <Container className="flex flex-wrap items-center justify-between gap-x-8 gap-y-4 py-6">
        <a href="#top" aria-label="FieldWork home" className="font-[var(--font-mono)] text-sm tracking-[0.22em] text-[var(--fw-text)]">
          FIELDWORK
        </a>
        ...
        <div className="order-2 md:order-3">
          <ButtonLink href="#pricing" variant="outline" ariaLabel="Log in to FieldWork">
            Log In
          </ButtonLink>
        </div>
      </Container>
